...
public class EmployeeAdmin {
    ...
    public static List<Employee> prepareReport(HashMap<String, Employee> table, List<String> socSecNums) {
        if (table == null) throw new IllegalArgumentException("Employee table cannot be null!");
        if (socSecNums == null) throw new IllegalArgumentException("List of social security number cannot be null!");
